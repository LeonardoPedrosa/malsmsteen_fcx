...
const input = tv({
  slots: {
    root: 'border border-zinc-700 bg-white',
    control: 'placeholder-zinc-500 text-zinc-900',
  },
  ...
  variants: {
    variant: {
      default: {},
      filter: {
        root: 'rounded-full py-1.5 px-3 flex items-center gap-1.5 text-xs text-zinc-500 leading-tight focus-within:border-red-900',
